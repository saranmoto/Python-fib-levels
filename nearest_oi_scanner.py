    ...
    def create_instance_for_list(stock_symbols: List[str]) -> None:
        ...
        for symbol in stock_symbols:
            ...
            if data:
                ...
                in_range = (
                    abs(close - call) <= 0.005 * call or
                    abs(close - put) <= 0.005 * put
                )
                if in_range:
...
if __name__ == '__main__':
    stock_list = [
        ...
        'ABCAPITAL', 'ABFRL', 'ALKEM', 'AMBUJACEM', 'ANGELONE', 'APOLLOHOSP', 'APOLLOTYRE', 'ASHOKLEY', 'ASIANPAINT', 'ASTRAL',
        'AUROPHARMA', 'DMART', 'AXISBANK', 'BSOFT', 'BSE', 'BAJAJ-AUTO', 'BAJFINANCE', 'BAJAJFINSV', 'BALKRISIND', 'BANDHANBNK',
        'BANKBARODA', 'BANKINDIA', 'BERGEPAINT', 'BEL', 'BHARATFORG', 'BHEL', 'BPCL', 'BHARTIARTL', 'BIOCON', 'BOSCHLTD',
        'BRITANNIA', 'CESC', 'CGPOWER', 'CANBK', 'CDSL', 'CHAMBLFERT', 'CHOLAFIN', 'CIPLA', 'COALINDIA', 'COFORGE',
        'COLPAL', 'CAMS', 'CONCOR', 'CROMPTON', 'CUMMINSIND', 'CYIENT', 'DLF', 'DABUR', 'DALBHARAT', 'DEEPAKNTR',
        'DELHIVERY', 'DIVISLAB', 'DIXON', 'DRREDDY', 'ETERNAL', 'EICHERMOT', 'ESCORTS', 'EXIDEIND', 'NYKAA', 'GAIL',
        'GMRAIRPORT', 'GLENMARK', 'GODREJCP', 'GODREJPROP', 'GRANULES', 'GRASIM', 'HCLTECH', 'HDFCAMC', 'HDFCBANK', 'HDFCLIFE',
        'HFCL', 'HAVELLS', 'HEROMOTOCO', 'HINDALCO', 'HAL', 'HINDCOPPER', 'HINDPETRO', 'HINDUNILVR', 'HINDZINC', 'HUDCO',
        'ICICIBANK', 'ICICIGI', 'ICICIPRULI', 'IDFCFIRSTB', 'IIFL', 'IRB', 'ITC', 'INDIANB', 'IEX', 'IOC',
        'IRCTC', 'IRFC', 'IREDA', 'IGL', 'INDUSTOWER', 'INDUSINDBK', 'NAUKRI', 'INFY', 'INOXWIND', 'INDIGO',
        'JSWENERGY', 'JSWSTEEL', 'JSL', 'JINDALSTEL', 'JIOFIN', 'JUBLFOOD', 'KEI', 'KPITTECH', 'KALYANKJIL', 'KOTAKBANK',
        'LTF', 'LICHSGFIN', 'LTIM', 'LT', 'LAURUSLABS', 'LICI', 'LUPIN', 'MRF', 'LODHA', 'MGL',
        'M%26MFIN', 'M%26M', 'MANAPPURAM', 'MARICO', 'MARUTI', 'MFSL', 'MAXHEALTH', 'MPHASIS', 'MCX', 'MUTHOOTFIN',
        'NBCC', 'NCC', 'NHPC', 'NMDC', 'NTPC', 'NATIONALUM', 'NESTLEIND', 'OBEROIRLTY', 'ONGC', 'OIL',
        'PAYTM', 'OFSS', 'POLICYBZR', 'PIIND', 'PNBHOUSING', 'PAGEIND', 'PATANJALI', 'PERSISTENT', 'PETRONET', 'PIDILITIND',
        'PEL', 'POLYCAB', 'POONAWALLA', 'PFC', 'POWERGRID', 'PRESTIGE', 'PNB', 'RBLBANK', 'RECLTD', 'RELIANCE',
        'SBICARD', 'SBILIFE', 'SHREECEM', 'SJVN', 'SRF', 'MOTHERSON', 'SHRIRAMFIN', 'SIEMENS', 'SOLARINDS', 'SONACOMS',
        'SBIN', 'SAIL', 'SUNPHARMA', 'SUPREMEIND', 'SYNGENE', 'TATACONSUM', 'TITAGARH', 'TVSMOTOR', 'TATACHEM', 'TATACOMM',
        'TCS', 'TATAELXSI', 'TATAMOTORS', 'TATAPOWER', 'TATASTEEL', 'TATATECH', 'TECHM', 'FEDERALBNK', 'INDHOTEL', 'PHOENIXLTD',
        'RAMCOCEM', 'TITAN', 'TORNTPHARM', 'TORNTPOWER', 'TRENT', 'TIINDIA', 'UPL', 'ULTRACEMCO', 'UNIONBANK', 'UNITDSPR',
